...
export class AvailabilityService {
  ...
  async checkAvailability(
    ...
    // TODO: Uncomment when VacationIntegrationService is available
    ...
    // TODO: Uncomment when ScheduleHelperService is available
    ...
    // For now, assume employee is available if not a holiday or rest day
    // This allows the availability check to work for interview scheduling
    return {
      employeeId,
      date,
      available: true,
      // workingHours, // TODO: Uncomment when ScheduleHelperService is available
    };
  }
